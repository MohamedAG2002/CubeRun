...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lpng16 -lm -lz -lm -lz -lharfbuzz -lm -lglib-2.0 -pthread -lm -lpcre -lfreetype -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon -lgraphite2 -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 26.1.20
